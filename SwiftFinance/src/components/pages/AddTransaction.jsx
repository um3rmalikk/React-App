...
const AddTransaction = () => {
  ...
  const [account, setAccount] = useState('Main Capital')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 👇 CRITICAL CHECK: Make sure user is logged in
      ...
      await addDoc(collection(db, "transactions"), {
        uid: user.uid, // 👈 THIS IS THE FIX! We link the data to YOU.
        title,
        ...
        account,
        note,
        createdAt: new Date().toISOString() // Using ISO string is safer for sorting
      })
  ...
  return (
    ...
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex-1 overflow-y-auto flex justify-center items-start p-6">
        <div className="bg-gray-800 p-8 rounded-2xl border border-gray-700 shadow-2xl w-full max-w-lg mt-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-gray-900 border border-gray-600 rounded-lg p-3 text-white focus:border-emerald-500 focus:outline-none transition resize-none"
                value={note}
